...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PD2     ------> UART5_RX
    */
    GPIO_InitStruct.Pin = PIN_LORA_EU_MOSI_UART5_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(PIN_LORA_EU_MOSI_UART5_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PIN_LORA_EU_MISO_UART5_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(PIN_LORA_EU_MISO_UART5_RX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = PIN_LORA_US_MOSI_UART2_TX_Pin|PIN_LORA_US_MISO_UART2_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(PIN_LORA_EU_MOSI_UART5_TX_GPIO_Port, PIN_LORA_EU_MOSI_UART5_TX_Pin);

    HAL_GPIO_DeInit(PIN_LORA_EU_MISO_UART5_RX_GPIO_Port, PIN_LORA_EU_MISO_UART5_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, PIN_LORA_US_MOSI_UART2_TX_Pin|PIN_LORA_US_MISO_UART2_RX_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PE15     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = PIN_MEMORY_SPI1_SCLK_Pin|PIN_MEMORY_SPI1_MISO_Pin|PIN_MEMORY_SPI1_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PE15     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, PIN_MEMORY_SPI1_SCLK_Pin|PIN_MEMORY_SPI1_MISO_Pin|PIN_MEMORY_SPI1_MOSI_Pin);
